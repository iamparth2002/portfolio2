...
export const DATA = {
  ...
  summary:
    "Full Stack Developer who juggles front-end and back-end code like a circus performer. I build web apps that look great, work smoothly, and might even make you laugh while you’re using them. In the past, [I pursued a bachelor degree in computer science](/#education), [interned at bubbling startups](/#work), and [built my own projects for fun](/#projects). ",
  ...
  work: [
    ...
    // },
    {
      ...
      description:
        `Developed The Colorants, a full stack web application, handling both frontend (Next.js, Zod, React Hook Form, Tailwind CSS, ShadCN) and backend (Node.js, Express, MongoDB, Mongoose, Cloudinary for image storage), including deployment on AWS.`,
    },
    {
      ...
      description:
        "During my internship as a Frontend Developer, I created responsive landing pages using React.js, Material-UI, and Bootstrap. I collaborated closely with designers, implemented reusable components, and optimized web pages for performance and cross-browser compatibility.",
    },
  ],
  education: [
    // {
    ...
    // },
    {
      ...
      degree: "Bachelor's Degree of Computer Science and Engineering (BE CSE)",
    ...
    },
    {
      ...
      href: "https://ramjaspusa.com/",
      degree: "12th Grade - 91%",
      logoUrl: "/ramjas-school.jpeg",
      start: "2018",
      end: "2020",
    },
    {
  ...
  projects: [
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/iamparth2002/ai-resume-builder",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/smartCV.png",
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/iamparth2002/cloudNova",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/cloudNova.png",
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/iamparth2002/pickup-line-generator",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/pickup.png",
